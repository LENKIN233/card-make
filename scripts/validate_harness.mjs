...
function validateGitWorkflow(errors) {
  ...
  if (gitWorkflow.version === 'card-make-git-workflow-v2') {
    ...
    for (const token of [
      ...
      'scripts/build_trusted_media_run_receipt.mjs',
      'lfs: false',
      'CARD_MAKE_TRUSTED_SOURCE_REPOSITORY',
      'CARD_MAKE_TRUSTED_PRODUCT_AUTHORITY_REPOSITORY',
      'source mirrors must remain outside runner job directories',
      'rev-parse refs/heads/main',
      'fsck --strict --no-reflogs',
